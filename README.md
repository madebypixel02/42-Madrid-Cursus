...
| Project | Description | Language | Date | Last Commit | Status |
| :-----: | :---------: | :------: | :--: | :---------: | :----: |
| [libft](https://github.com/madebypixel02/libft) | Your very first own library | C, Makefile | April 2021 | ![GitHub Last Commit](https://img.shields.io/github/last-commit/madebypixel02/libft/master) | [![aperez-b's 42Project Score](https://badge42.herokuapp.com/api/project/aperez-b/Libft)](https://github.com/JaeSeoKim/badge42) |
...
| [born2beroot](https://github.com/madebypixel02/born2beroot) | The wonderful world of virtualization | Shell, Virtualization | N/A | ![GitHub Last Commit](https://img.shields.io/github/last-commit/madebypixel02/born2beroot/master) | N/A |
